...
import { 
  ...
  Building2, PlayCircle, History, Clock, Copy, ArrowRight, Edit2
} from 'lucide-react';
  ...
  const renderComments = () => (
    <div className="flex flex-col h-full">
      ...
      <form onSubmit={handleAddComment} className="mt-2 pt-2 border-t border-gray-100 dark:border-gray-700 flex gap-2">
         ...
         />
         <button type="submit" disabled={!newComment.trim()} className="bg-gray-900 dark:bg-gray-700 text-white rounded-md p-2.5 disabled:opacity-50">
